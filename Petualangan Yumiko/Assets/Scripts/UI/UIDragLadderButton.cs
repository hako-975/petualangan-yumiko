...
public class UIDragLadderButton : MonoBehaviour, IDragHandler
{
    Vector2 currentPos;
    Vector3 newPos;
    RectTransform tr;
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        PlayerPrefsManager.instance.SetLadderButtonPositionX(transform.position.x);
        PlayerPrefsManager.instance.SetLadderButtonPositionY(transform.position.y);
    }
}
